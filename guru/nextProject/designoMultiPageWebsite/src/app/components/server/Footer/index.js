...
export default function Footer({ children, page }) {
  return (
    <footer role="content-info" className={styles[`footer`]}>
      <div className={styles[`logo-nav-container`]}>
        <a href="/">
          <img
            ...
            alt="orange circle next to desig no company logo"
          />
        </a>
        {/* mobile seperator */}
        <span className={styles[`mobile-seperator`]}></span>
        <nav role="navigation" className={styles[`secondary-nav`]}>
      ...
      {/* tablet and desktop seperator */}
      <span className={styles[`tablet-seperator`]}></span>
      <div className={styles[`address-contact-social-container`]}>
        ...
        <div className={styles[`social-media-icons`]}>
          {/* facebook */}
          <a className={styles[`icon-container`]} href="/">
